namespace DoCeluNaCzasMobile.DataAccess.Repository.Net.Helpers
{
    public class Urls
    {
        ...
        public static string BUS_STOPS = SERVER_CONNECTION + "api/BusStop";
        ...
        public static string ROUTE_SEARCH = SERVER_CONNECTION +
                                            "api/RouteSearch?startStopId={0}&destStopId={1}&departure={2}&desiredTime={3}";
    }
}